      ...
      {testimonial.length && (
        <>
          <div className="app__testimonial-item app__flex">
            <img src={urlFor(testimonial[currentIndex].imgUrl)} alt="testimonial" className="" />
            <div className="app__testimonial-content">
              <p className="p-text">{testimonial[currentIndex].feedback}</p>
              <div className="bold-text">{testimonial[currentIndex].name}</div>
              <p className="bold-text">{testimonial[currentIndex].company}</p>
            </div>
          </div>
